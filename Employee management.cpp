...
cout<<"Salary:";
cin>>Salary; }
[0:17 pm, 12/12/2022] Sahil  Abak: void Employee::DisplayRecord()
{
...
switch(option)
{
[0:17 pm, 12/12/2022] Sahil  Abak: case '1':
emp.ReadData();
...
e.DisplayRecord();
isFound=1;
[0:17 pm, 12/12/2022] Sahil  Abak: break;
}
file.read((char*)&e,sizeof(e));
}
file.clear();
...
file.seekg(0,ios::beg);
int counter=0;
[0:17 pm, 12/12/2022] Sahil  Abak: file.read((char*)&e,sizeof(e));
while(!file.eof())
{
counter++;
if(counter==1)
...
[0:17 pm, 12/12/2022] Sahil  Abak: else
{
file.clear();
file.seekg(0,ios::beg);
file.read((char*)&e,sizeof(e));
